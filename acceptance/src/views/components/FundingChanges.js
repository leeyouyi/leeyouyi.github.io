...
const FundingChanges = props =>{
    ...
    const infoData = [
        ...
        {
            text: t('table.amount_incurred'),
        },
        {
            text: t('table.opening_balance'),
        },
        {
            text: t('table.ending_balance'),
        },
        {
                        ...
                        inputData.map((item,index)=>{
                            return(
                                <div className="input" key={index}>
                                    <div className="text">
                                        <label style={{
                                            justifyContent: item.end ?'center':'export',
